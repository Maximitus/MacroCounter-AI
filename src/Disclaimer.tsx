  ...
  return (
    ...
    >
      <div className="glass flex max-h-[min(90vh,40rem)] w-full max-w-lg flex-col rounded-2xl border border-[#ff8800]/10 shadow-xl orange-glow">
        ...
        <div
          id="disclaimer-body"
          className="min-h-0 flex-1 overflow-y-auto px-5 py-4 text-sm leading-relaxed text-[var(--color-text-light)]"
        >
          <DisclaimerBody />
        </div>
      ...
      {voluntaryOpen && (
        ...
        >
          <div className="glass flex max-h-[min(85vh,36rem)] w-full max-w-lg flex-col rounded-2xl border border-[#ff8800]/10 shadow-xl orange-glow">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4 text-sm leading-relaxed text-[var(--color-text-light)]">
              <DisclaimerBody />
            </div>
          </div>
        </div>
